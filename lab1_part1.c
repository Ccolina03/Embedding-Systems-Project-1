...
#define KYPD_DEVICE_ID XPAR_AXI_KEYPAD_DEVICE_ID // 1

/*************************** Enter your code here ****************************/
// TODO: Define the seven-segment display (SSD) device id here.
#define SSD_DEVICE_ID XPAR_AXI_SSD_DEVICE_ID // 3
/*****************************************************************************/
...
/*************************** Enter your code here ****************************/
	...
	XGpio_SetDataDirection(&SSDInst, 1, 0x00); //0x00 for output and 0xFF for input
/*****************************************************************************/
	...
	vTaskStartScheduler();
	while(1); // Facilitate debugging | Program stays in memory/stack if scheduler crashes
	return 0;
}
...
static void keypadTask( void *pvParameters )
{
	...
	u8 pressed_key, current_key = 'x', previous_key = 'x';
	u32 ssd_value=0;

/*************************** Enter your code here ****************************/
	// TODO: Define a constant of type TickType_t named 'xDelay' and initialize
	//       it with a value of 100 divided by portTICK_RATE_MS for the SSD delay.
	const TickType_t xDelay = 12 / portTICK_RATE_MS;
...
/*****************************************************************************/
	...
	while (1){
		...
		// if a key is pressed, store the value of the new key in pressed_key
		status = KYPD_getKeyPressed(&KYPDInst, keystate, &pressed_key);
...
/*************************** Enter your code here ****************************/
		...
		*/
		...
		//Left 7-segment and moving to left old one(like queue, pulling from left)
